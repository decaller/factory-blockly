...
export function defineGenerators() {
    ...
    // --- Sensor generators ---
    javascriptGenerator.forBlock['sensor_robot_x'] = function(block) {
        return ['getRobotX()', javascriptGenerator.ORDER_FUNCTION_CALL];
    };
    javascriptGenerator.forBlock['sensor_robot_y'] = function(block) {
        return ['getRobotY()', javascriptGenerator.ORDER_FUNCTION_CALL];
    };
    javascriptGenerator.forBlock['sensor_crate_x'] = function(block) {
        return ['getCrateX()', javascriptGenerator.ORDER_FUNCTION_CALL];
    };
    javascriptGenerator.forBlock['sensor_crate_y'] = function(block) {
        return ['getCrateY()', javascriptGenerator.ORDER_FUNCTION_CALL];
    };
    ...
    javascriptGenerator.forBlock['debug_log'] = function(block) {
        ...
        if (inputBlock) {
            const labelMap = {
                'sensor_robot_x': 'robot X position',
                'sensor_robot_y': 'robot Y position',
                'sensor_crate_x': 'crate X position',
                'sensor_crate_y': 'crate Y position',
